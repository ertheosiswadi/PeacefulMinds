...
class APIHelper {
    ...
    func getAllHospitals(username:String, procedure: String, completeHandler: @escaping (_ profile: [[String:Any]]) -> ())
    {
    ...
    func getHospitalsInArea(username:String, procedure: String, completeHandler: @escaping (_ profile: [[String:Any]]) -> ())
    {
        let uri = "https://peaceful-minds.herokuapp.com/same_area/\(username)/\(procedure)";
        let endpoint:String = uri
        print("debug - get - url \(endpoint)")
        let url = URL(string: endpoint)
        let urlRequest = URLRequest(url: url!)
